          ...
          <div className='flex items-center justify-between h-20'>
            ...
            >
              ...
              <motion.button
                ...
                className='relative w-12 h-12 rounded-full bg-[#c9f31d] flex items-center justify-center focus:outline-none hover:bg-[#0d6665] transition-colors'
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                  ...
                  >
                    ...
                    <div className='flex gap-4 justify-center'>
                      <a
                        ...
                        className='w-12 h-12 rounded-full bg-white flex items-center justify-center hover:bg-[#c9f31d] transition-colors group'
                      >
