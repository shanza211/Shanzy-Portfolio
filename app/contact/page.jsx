            ...
            >
              ...
              <div>
                ...
                <div className='flex gap-4'>
                  <a
                    href='#'
                    className='w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-[#c9f31d] transition-colors'
                  >
            ...
            >
              <form onSubmit={handleSubmit} className='space-y-6'>
                ...
                <button
                  ...
                  className='w-full bg-[#c9f31d] hover:bg-[#0d6665] text-white px-8 py-4 rounded-full font-bold text-base transition-all duration-300 shadow-lg hover:shadow-[#c9f31d]/50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2'
                >
