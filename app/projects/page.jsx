  ...
  const projects = [
    {
      ...
      description:
        'Comprehensive analytics platform for Amazon sellers featuring real-time data visualization, inventory management, and profit tracking with modern glassmorphism design.',
    ...
    },
    {
      ...
      description:
        'Complete design system library with 100+ components featuring modern glassmorphism aesthetics, accessibility guidelines, and comprehensive documentation.',
    ...
    },
    {
      ...
      description:
        'Modern mobile commerce application with seamless shopping experience, secure payments, and real-time order tracking.',
    ...
    },
    {
      ...
      description:
        'Responsive portfolio template for creatives featuring smooth animations, dark theme, and optimized performance.',
    ...
    },
    {
      ...
      description:
        'Interactive dashboard for complex data visualization with real-time updates and customizable charts.',
    ...
    },
    {
      ...
      description:
        'High-converting landing page for SaaS products with modern design and optimized conversion funnel.',
    ...
    },
    {
      ...
      description:
        'Intuitive mobile banking app interface with secure authentication and transaction management.',
    ...
    },
    {
      ...
      description:
        'Comprehensive API management solution with monitoring, authentication, and developer portal.',
