            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
              <div>
                <p className='text-gray-300 text-lg leading-relaxed mb-6'>
                  ...
                  technology intersect to solve real-world problems. Starting as
                  a self-taught designer, I quickly discovered the power of
                ...
                <p className='text-gray-300 text-lg leading-relaxed mb-6'>
                  ...
                  helping them bring their digital visions to life through
                  thoughtful design and clean code.
                </p>
                <p className='text-gray-300 text-lg leading-relaxed'>
                  Today, I continue to push the boundaries of what's possible in
                  web design, particularly in the realm of glassmorphism and
                  modern UI patterns, while maintaining a strong focus on
