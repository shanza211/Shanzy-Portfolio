...
export default function About() {
  ...
  const experiences = [
    {
      ...
      period: '2022 - Present',
      description: 'Leading design initiatives for modern web applications, specializing in glassmorphism and user-centered design principles.',
      achievements: [
    ...
    },
    {
      ...
      period: '2021 - 2022',
      description: 'Developed data analysis tools and automation scripts for business intelligence platforms.',
      achievements: [
    ...
    },
    {
      ...
      period: '2020 - 2021',
      description: 'Provided design and development services for startups and small businesses.',
      achievements: [
  ...
  const values = [
    ...
    },
    {
      ...
      description: 'Staying updated with the latest technologies and design trends to deliver cutting-edge solutions.',
      icon: '📚'
    },
    {
      title: 'Collaboration',
        ...
        >
          <motion.div variants={itemVariants} className="mb-8">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
              About <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Shanzy</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              I'm a passionate UI/UX designer and Python developer with over 4 years of experience creating beautiful, 
              functional digital experiences. I specialize in modern design systems, glassmorphism aesthetics, and 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  ...
                  Starting as a self-taught designer, I quickly discovered the power of combining beautiful interfaces with 
                  robust backend systems.
                </p>
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  Over the years, I've had the privilege of working with startups, established companies, and individual 
                  entrepreneurs, helping them bring their digital visions to life through thoughtful design and clean code.
                </p>
                <p className="text-gray-300 text-lg leading-relaxed">
                  Today, I continue to push the boundaries of what's possible in web design, particularly in the realm of 
                  glassmorphism and modern UI patterns, while maintaining a strong focus on performance and accessibility.
                </p>
              </div>
              <div className="space-y-6">
                <div className="glass-card p-6 rounded-2xl">
                  <h3 className="text-xl font-semibold text-white mb-2">4+ Years</h3>
                  <p className="text-gray-400">Professional Experience</p>
                </div>
                <div className="glass-card p-6 rounded-2xl">
                  <h3 className="text-xl font-semibold text-white mb-2">100+ Projects</h3>
                  <p className="text-gray-400">Successfully Delivered</p>
                </div>
                <div className="glass-card p-6 rounded-2xl">
                  <h3 className="text-xl font-semibold text-white mb-2">50+ Clients</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {tools.map((tool, index) => (
              ...
              >
                ...
                <span className="text-xs text-gray-400">{tool.proficiency}%</span>
              </motion.div>
            ))}
          </div>
        </motion.section>
