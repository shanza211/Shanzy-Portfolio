      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="text-gray-300 space-y-4">
            <p>
              Welcome to Shanzy's Portfolio. These Terms of Service ("Terms") govern your use of our website 
        ...
        >
          ...
          <div className="text-gray-300 space-y-4">
            <p>
              In simple terms: We want to provide you with excellent design and development services while 
              protecting both your interests and ours. These terms ensure clear expectations for our working 
              relationship.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              ...
              <div>
                <h4 className="text-white font-semibold mb-2">Your Responsibilities:</h4>
                <ul className="space-y-1 text-sm">
        ...
        >
          ...
          <div className="text-gray-300 space-y-4">
            <p>
              If you have any questions about these Terms of Service, please contact us. We're happy to 
              clarify any provisions or discuss how they apply to your specific situation.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex items-center">
                <span className="text-blue-400 mr-2">📧</span>
                <a href="mailto:legal@shanzy.dev" className="text-blue-400 hover:text-blue-300 transition-colors duration-200">
                  legal@shanzy.dev
                </a>
              </div>
              <div className="flex items-center">
