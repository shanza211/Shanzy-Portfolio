...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/in/shanzy',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="md:col-span-2">
              ...
              >
                ...
                <p className="mt-4 text-gray-400 max-w-md">
                  UI/UX Designer & Python Developer crafting modern, user-centered digital experiences with glassmorphism aesthetics and cutting-edge technology.
                </p>
          ...
          >
            <p className="text-gray-400 text-sm">
              © {currentYear} Shanzy. All rights reserved. Built with Next.js & Tailwind CSS.
            </p>
            <div className="flex items-center space-x-4 mt-4 md:mt-0">
              ...
              <span className="text-gray-400 text-sm">in Pakistan</span>
            </div>
          </motion.div>
        </div>
      </div>
