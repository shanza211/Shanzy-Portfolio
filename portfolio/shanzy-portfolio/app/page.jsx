  ...
  const featuredProjects = [
    {
      ...
      description: 'Advanced analytics platform for Amazon sellers with real-time insights and performance tracking.',
      image: '/project-1.jpg',
    ...
    },
    {
      ...
      description: 'Complete design system with reusable components featuring modern glassmorphism aesthetics.',
      image: '/project-2.jpg',
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Crafting beautiful, functional digital experiences with modern design principles and cutting-edge technology. 
            Specializing in glassmorphism aesthetics and user-centered solutions.
          </motion.p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              A showcase of my recent work combining design excellence with technical innovation
            </p>
          </motion.div>
        ...
        >
          <div className="glass-card p-12 rounded-3xl">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Let's collaborate on creating something amazing together. I'm always excited to work on new challenges.
            </p>
            <motion.div
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
