      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="text-gray-300 space-y-4">
            <p>
              Welcome to Shanzy's Portfolio. This Privacy Policy explains how we collect, use, disclose, and 
              safeguard your information when you visit our website or use our services. Please read this 
              privacy policy carefully.
            </p>
            <p>
              By accessing or using our website, you agree to this Privacy Policy. If you do not agree with 
          ...
          <div className="text-gray-300 space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex items-center">
                ...
                <a href="mailto:privacy@shanzy.dev" className="text-blue-400 hover:text-blue-300 transition-colors duration-200">
                  privacy@shanzy.dev
                </a>
              </div>
              <div className="flex items-center">
