          ...
          <div className='glass-card p-12 rounded-3xl'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
              ...
              <div>
                ...
                <p className='text-gray-400'>
                  Absolutely! I've worked with clients from around the world and
                  I'm comfortable with different time zones and communication
                  preferences.
                </p>
              </div>
              <div>
                ...
                <p className='text-gray-400'>
                  ...
                  high-fidelity prototypes, design system, and developer handoff
                  documentation.
                </p>
              </div>
              <div>
                ...
                <p className='text-gray-400'>
                  Yes! I offer maintenance packages and ongoing support for all
                  projects. We can discuss the details based on your specific
                  needs.
                </p>
              </div>
            </div>
