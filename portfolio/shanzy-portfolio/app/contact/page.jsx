  ...
  const services = [
    {
      ...
      features: ['Wireframing & Prototyping', 'User Research', 'Design Systems', 'Figma Design'],
    ...
    },
    {
      ...
      features: ['Web APIs', 'Data Analysis', 'Automation Scripts', 'Database Integration'],
      price: 'Starting at $800'
    },
    {
      title: 'Full Project',
      description: 'End-to-end solution from design to deployment',
      features: ['Complete Design System', 'Frontend & Backend', 'Deployment & Hosting', '3 Months Support'],
    ...
    <div className="min-h-screen py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.section
          ...
          className="mb-20"
        >
          <h2 className="text-3xl font-bold text-white mb-12 text-center">Services & Pricing</h2>
        ...
        >
          <div className="glass-card p-12 rounded-3xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">What's your typical project timeline?</h3>
                <p className="text-gray-400">Most projects take 2-8 weeks depending on complexity. I'll provide a detailed timeline during our initial consultation.</p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Do you work with international clients?</h3>
                <p className="text-gray-400">Absolutely! I've worked with clients from around the world and I'm comfortable with different time zones and communication preferences.</p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">What's included in your design service?</h3>
                <p className="text-gray-400">Complete design process from research and wireframes to high-fidelity prototypes, design system, and developer handoff documentation.</p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Do you provide ongoing support?</h3>
                <p className="text-gray-400">Yes! I offer maintenance packages and ongoing support for all projects. We can discuss the details based on your specific needs.</p>
              </div>
            </div>
          </div>
        </motion.section>
