      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Blog</span> & Insights
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Thoughts, tutorials, and insights on design, development, and the intersection of creativity and technology.
          </p>
        </motion.div>
        ...
        >
          <div className="glass-card p-12 rounded-3xl text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Get notified when I publish new articles about design, development, and technology.
            </p>
